...
// demo for CI
		...
		camcorderList.add(new Camcorder("CC001", "Sony HDR-CX405", 35)); // camera
		camcorderList.add(new Camcorder("CC002", "Panasonic HC-MDH2", 10)); //bbc
		chromebookList.add(new Chromebook("CB001", "ASUS Chromebook ", "Win 10"));//hello
